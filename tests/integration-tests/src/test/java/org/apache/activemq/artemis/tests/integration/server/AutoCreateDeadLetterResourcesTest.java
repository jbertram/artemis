...
public class AutoCreateDeadLetterResourcesTest extends ActiveMQTestBase {
   ...
   public void testOngoingSendToDLAPreventAutoDelete() throws Exception {
      ...
      QueueControl queueControl = (QueueControl)server.getManagementService().getQueueControl(queueA.toString());
      queueControl.sendMessagesToDeadLetterAddress(null);

      QueueControl dlqControl = (QueueControl)server.getManagementService().getQueueControl(dlqName.toString());
