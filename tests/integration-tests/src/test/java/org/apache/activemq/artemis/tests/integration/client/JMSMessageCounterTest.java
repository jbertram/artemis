...
public class JMSMessageCounterTest extends JMSTestBase {
   ...
   public void testMessageCounter() throws Exception {
      ...
      QueueControl control = (QueueControl) server.getManagementService().getQueueControl(queue.getQueueName());
      ...
      control = (QueueControl) server.getManagementService().getQueueControl(queue.getQueueName());
      assertNotNull(control);
