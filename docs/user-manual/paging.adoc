...
{project-name-full} will create one folder for each address being paged under this configured location.
...
See the xref:examples.adoc#paging[Paging Example] which shows how to use paging with  {project-name-full}.
