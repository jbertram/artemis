...
{project-name-full} includes powerful automatic duplicate message detection, filtering out duplicate messages without you having to code your own fiddly duplicate detection logic at the application level.
This chapter will explain what duplicate detection is, how {project-name-full} uses it, and how to configure it.
...
To solve these issues {project-name-full} provides automatic duplicate messages detection for messages sent to addresses.
