...
* xref:preface.adoc#why-use-apache-activemq-artemis[Why use {project-name-full}?]
...
* xref:embedding-activemq.adoc#embedding-apache-activemq-artemis[Embedding {project-name-full}]
