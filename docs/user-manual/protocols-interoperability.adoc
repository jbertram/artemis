...
{project-name-full} implements the https://www.oasis-open.org/committees/tc_home.php?wg_abbrev=amqp[AMQP 1.0] specification.
Any client that supports the 1.0 specification will be able to interact with {project-name-full}.
...
In order to support ActiveMQ clients, {project-name-full} supports OpenWire.
