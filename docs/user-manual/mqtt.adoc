...
{project-name-full} also supports MQTT over https://html.spec.whatwg.org/multipage/web-sockets.html[Web Sockets].
...
With this configuration, {project-name-full} will accept MQTT connections over Web Sockets on the port `1883`.
