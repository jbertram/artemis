...
AMQP over https://html.spec.whatwg.org/multipage/web-sockets.html[Web Sockets] is also supported.
...
With this configuration, the broker will accept AMQP connections over Web Sockets on the port `5672`.
