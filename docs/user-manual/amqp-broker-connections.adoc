...
It is also possible to specify alternate hosts on a broker connections:
- The backup a broker connection can be specified with a #.
...
----
<broker-connections>
  <amqp-connection uri="tcp://ServerA:5672#tcp://BackupA:5672" name="ServerA" reconnect-attempts="-1" retry-interval="5000">
    ...
  </amqp-connection>
</broker-connections>
----

if you need to specify more than 2 elements, you can use a comma separated list after the first pair:
...
----
<broker-connections>
  <amqp-connection uri="tcp://ServerA:5672#tcp://BackupA:5672,tcp://BackupB:5672,tcp://BackupC:5672" name="ServerA" reconnect-attempts="-1" retry-interval="5000">
    ...
  </amqp-connection>
</broker-connections>
----
