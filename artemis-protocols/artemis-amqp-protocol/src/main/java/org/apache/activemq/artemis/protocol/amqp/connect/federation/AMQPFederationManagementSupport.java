...
public abstract class AMQPFederationManagementSupport {
   ...
   public static void registerFederationSource(AMQPFederationSource federation) throws Exception {
      ...
      management.registerUntypedControl(getFederationSourceResourceName(brokerConnectionName, federationName), control);
   }
   ...
   public static void registerFederationTarget(String remoteNodeId, String brokerConnectionName, AMQPFederationTarget federation) throws Exception {
      ...
      management.registerUntypedControl(getFederationTargetResourceName(remoteNodeId, brokerConnectionName, federationName), control);
   }
   ...
   public static void registerLocalPolicyOnSource(String brokerConnectionName, AMQPFederationLocalPolicyManager manager) throws Exception {
      ...
      management.registerUntypedControl(getFederationSourcePolicyResourceName(brokerConnectionName, federationName, policyName), control);
   }
   ...
   public static void registerLocalPolicyOnTarget(String remoteNodeId, String brokerConnectionName, AMQPFederationLocalPolicyManager manager) throws Exception {
      ...
      management.registerUntypedControl(getFederationTargetPolicyResourceName(remoteNodeId, brokerConnectionName, federationName, policyName), control);
   }
   ...
   public static void registerFederationSourceConsumer(String brokerConnectionName, AMQPFederationConsumer consumer) throws Exception {
      ...
      if (consumer.getRole() == FederationConsumerInfo.Role.ADDRESS_CONSUMER) {
         ...
         management.registerUntypedControl(getFederationSourceAddressConsumerResourceName(brokerConnectionName, federationName, policyName, consumer.getConsumerInfo().getAddress()), control);
      } else {
         ...
         management.registerUntypedControl(getFederationSourceQueueConsumerResourceName(brokerConnectionName, federationName, policyName, consumer.getConsumerInfo().getFqqn()), control);
      }
   }
   ...
   public static void registerFederationSourceProducer(String brokerConnectionName, AMQPFederationSenderController sender) throws Exception {
      ...
      if (sender.getRole() == Role.ADDRESS_PRODUCER) {
         ...
         management.registerUntypedControl(getFederationSourceQueueProducerResourceName(brokerConnectionName, federationName, policyName, fqqn), control);
      }
   }
   ...
   public static void registerFederationTargetConsumer(String remoteNodeId, String brokerConnectionName, AMQPFederationConsumer consumer) throws Exception {
      ...
      if (consumer.getRole() == FederationConsumerInfo.Role.ADDRESS_CONSUMER) {
         ...
         management.registerUntypedControl(getFederationTargetAddressConsumerResourceName(remoteNodeId, brokerConnectionName, federationName, policyName, consumer.getConsumerInfo().getAddress()), control);
      } else {
         ...
         management.registerUntypedControl(getFederationTargetQueueConsumerResourceName(remoteNodeId, brokerConnectionName, federationName, policyName, consumer.getConsumerInfo().getFqqn()), control);
      }
   }
   ...
   public static void registerFederationTargetProducer(String remoteNodeId, String brokerConnectionName, AMQPFederationSenderController sender) throws Exception {
      ...
      if (sender.getRole() == Role.ADDRESS_PRODUCER) {
         ...
         management.registerUntypedControl(getFederationTargetQueueProducerResourceName(remoteNodeId, brokerConnectionName, federationName, policyName, fqqn), control);
      }
   }
