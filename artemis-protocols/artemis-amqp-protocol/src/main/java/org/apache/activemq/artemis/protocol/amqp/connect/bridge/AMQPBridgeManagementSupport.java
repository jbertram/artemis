...
public final class AMQPBridgeManagementSupport {
   ...
   public static void registerBridgeManager(AMQPBridgeManager bridge) throws Exception {
      ...
      management.registerUntypedControl(getBridgeManagerResourceName(brokerConnectionName, bridgeName), control);
   }
   ...
   public static void registerBridgePolicyManager(AMQPBridgePolicyManager manager) throws Exception {
      ...
      management.registerUntypedControl(getBridgePolicyManagerResourceName(brokerConnectionName, bridgeName, policyName), control);
   }
   ...
   public static void registerBridgeReceiver(AMQPBridgeReceiver receiver) throws Exception {
      ...
      if (receiver.getRole() == ReceiverRole.ADDRESS_RECEIVER) {
         ...
         management.registerUntypedControl(getBridgeAddressReceiverResourceName(brokerConnectionName, bridgeName, policyName, receiver.getReceiverInfo().getLocalAddress()), control);
      } else {
         ...
         management.registerUntypedControl(getBridgeQueueReceiverResourceName(brokerConnectionName, bridgeName, policyName, receiver.getReceiverInfo().getLocalFqqn()), control);
      }
   }
   ...
   public static void registerBridgeSender(AMQPBridgeToSenderController sender) throws Exception {
      ...
      if (sender.getRole() == SenderRole.ADDRESS_SENDER) {
         ...
         management.registerUntypedControl(getBridgeQueueSenderResourceName(brokerConnectionName, bridgeName, policyName, fqqn), control);
      }
   }
