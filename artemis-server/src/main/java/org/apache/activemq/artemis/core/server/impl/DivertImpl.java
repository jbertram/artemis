...
public class DivertImpl implements Divert {
   ...
   public void route(final Message message, final RoutingContext context) throws Exception {
      ...
      for (SimpleString forwardAddress : forwardAddresses) {
         ...
         postOffice.route(copy, new RoutingContextImpl(context.getTransaction()).setReusable(false).setRoutingType(copy.getRoutingType()).setServerSession(context.getServerSession()));
      }
   }
